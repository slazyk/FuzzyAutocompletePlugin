//
//  LSLFuzzyAutocompleteSettings.h
...
@interface LSLFuzzyAutocompleteSettings : NSObject
...
@property (nonatomic, readonly) NSInteger anchorLength;
...
// scoring method parameters, see LSLItemScoringMethod 
